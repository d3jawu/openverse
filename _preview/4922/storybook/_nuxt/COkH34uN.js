import{W as I}from"./Cu7nQ9EK.js";import{V as m}from"./CGHqfD1T.js";import{_ as e}from"./BvNLlYDq.js";import{A as T,h as n}from"./BEWIBK-i.js";import"./CuPsdpTl.js";import"./CFMQYC2y.js";import"./DlAUqK2U.js";import"./uZ-0lEQS.js";const a={fieldId:"fruit",blankText:"Fruit",labelText:"Fruit",choices:[{key:"a",text:"Apple"},{key:"b",text:"Banana"},{key:"c",text:"Cantaloupe"}]},M={title:"Components/VSelectField",component:e,decorators:[I],argTypes:{"onUpdate:modelValue":{action:"update:modelValue"}}},y={render:r=>({components:{VSelectField:e},setup(){return()=>n(e,r)}}),args:{}},t={...y,name:"Default",args:a},o={...y,name:"Without border",args:{...a,variant:"borderless"}},s={render:r=>({components:{VSelectField:e},setup(){const l=T("a");return()=>n("div",[n(e,{...r,modelValue:l.value}),l.value])}}),name:"v-model",args:a},c={render:r=>({components:{VSelectField:e,VIcon:m},setup(){return()=>n(e,r,{start:()=>n(m,{name:"radiomark"})})}}),name:"With icon",args:a},i={render:r=>({components:{VSelectField:e,VIcon:m},setup(){return()=>n(e,{...r,class:"max-w-[100px]"},{start:()=>n(m,{name:"radiomark"})})}}),name:"With constraints",args:{...a,choices:[{key:"short",text:"Kiwi"},{key:"long",text:"Bob Gordon American Elderberry"}]}};var d,p,u;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...
  name: "With icon",
  args: baseArgs
}`,...(F=(W=c.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};var k,A,v;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => ({
    components: {
      VSelectField,
      VIcon
...
}`,...(v=(A=i.parameters)==null?void 0:A.docs)==null?void 0:v.source}}};const O=["Default","WithoutBorder","VModel","WithIcon","WithConstraints"];export{t as Default,s as VModel,i as WithConstraints,c as WithIcon,o as WithoutBorder,O as __namedExportsOrder,M as default};
